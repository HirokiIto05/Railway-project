main <- function(){
  ...
  df_bar_based <- purrr::map(list_file_path, read_plot,
                             df_master) |> 
    dplyr::bind_rows()
...
create_bar_plot <- function(df_bar_based){
  ...
  ggsave(output_plot_five, filename = "04.analyze/new/03_plot/04_bar/figure/five_all.png", 
         width = 8, height = 6)
  ...
  ggsave(output_plot_ten, filename = "04.analyze/new/03_plot/04_bar/figure/ten_all.png", width = 8, height = 6)
