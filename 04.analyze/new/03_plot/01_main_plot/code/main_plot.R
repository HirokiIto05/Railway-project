...
main <- function(){
  ...
  # list_treatment_files <- list.files("04.analyze/new/01_data/data/pre_year/")
  # list_data <- list_data[order(match(list_data, list_treatment_files))]
  
  
}

list_main <- purrr::map(list_treatment_files, read_plot, df_master)

file_path <- list_treatment_files[8]
...
plot_nine_agg <- 
  ...
  list_main[[13]] + list_main[[14]] + list_main[[15]] +
  list_main[[16]] + plot_spacer() + plot_spacer() +
  plot_layout(ncol = 3,
              nrow = 6,
...
ggsave(plot_nine_agg,
       filename = '04.analyze/new/03_plot/01_main_plot/figure/pre_year/main.png',
       height = 12,
       width = 8)
...
ggsave(plot_nine_agg,
       filename = '04.analyze/new/03_plot/01_main_plot/figure/main_921.png',
       height = 12,
       width = 8)
