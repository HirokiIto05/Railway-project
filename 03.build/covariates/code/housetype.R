main <- function(){
  ...
  all_housetype_data <- all_housetype_data |> 
    dplyr::mutate(own_household = str_replace_all(own_household, ",",""),
                  own_pop = str_replace_all(own_pop, ",",""),
                  rent_household = str_replace_all(rent_household, ",",""),
                  rent_pop = str_replace_all(rent_pop, ",","")) |> 
    dplyr::mutate_at(dplyr::vars(-city_name), as.numeric)

  save_df_csv(all_housetype_data, "covariates", "housetype")
